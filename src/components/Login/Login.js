    ...
    <section className="register login">
      <AuthForm isValid={isValid}>
        ...
        <div className="register__wrapper">
          ...
          <input className="register__item register__item_for_password" type="password" id="password" name="password" placeholder="E-mail" value={values.password || ""} onChange={handleChange} />
